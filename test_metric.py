...
class Metric():
    ...
    def get_MSD(self):
        ...
        for num in range(1, self.num_classes + 1):
            ...
            surface_distance = surfd(self.pred_mask == num,self.real_mask==num)
            smd.append(surface_distance.mean())
        # return round(np.nanmean(smd),2)
        return np.nanmean(smd)
        # return smd
