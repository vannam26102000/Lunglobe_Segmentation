...
class UNet(nn.Module):
    def __init__(self, in_channels=1, n_classes=6, depth=5, wf=6, padding=False,
...
# model = UNet(in_channels=1, n_classes=6, depth=5, wf=6, padding=False,batch_norm=True, up_mode='upsample', residual=True)
# print(model)