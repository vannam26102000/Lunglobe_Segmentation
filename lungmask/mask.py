...
model_urls = {('unet', 'R231'): ('https://github.com/JoHof/lungmask/releases/download/v0.0/unet_r231-d5d2fc3d.pth', 3),
              ('unet', 'LTRCLobes'): (
                  'https://drive.google.com/drive/folders/1PZCZ3yrf_o0a7GoNbg4MFBmWqmo6hLq8?usp=drive_link', 6),
              }


def apply(image, model=None, force_cpu=False, batch_size=16, volume_postprocessing=True, noHU=False):
    if model is None:
    ...
    # postprocessing includes removal of small conneted components, hole filling and mapping of small components to
    # neighbors
...
def get_model(modeltype, modelname, modelpath=r'C:\Users\FR\PycharmProjects\Qtdesigner\Nam\lungmask\checkpoint\net50-0.004-0.006.pth', n_classes=6):
